...
1. Fork in GitHub https://github.com/atsign-foundation/at_split_horizon_root
2. Clone *your forked repository* (e.g., `git clone git@github.com:yourname/at_split_horizon_root`)
3. Set your remotes as follows:

   ```sh
   cd at_split_horizon_root
   git remote add upstream git@github.com:atsign-foundation/at_split_horizon_root.git
   ...
   ```text
   origin  git@github.com:yourname/at_split_horizon_root.git (fetch)
   origin  git@github.com:yourname/at_split_horizon_root.git (push)
   upstream        git@github.com:atsign-foundation/at_split_horizon_root.git (fetch)
